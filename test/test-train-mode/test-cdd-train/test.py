...
def _compile(classifier, batch_size, x, y, index, train_set_x, train_set_y, L1_reg=0.00, L2_reg=0.0001, learning_rate=0.01):
    ...
    return train, get_gradient, descent, shared_grads
...
def test(n_epochs=10, dataset='../mlp_base/mnist.pkl.gz', batch_size=20, n_hidden=500):
    ...
    train_full, _ , _, _  = _compile(classifier_full, 2, x, y, index, train_set_x, train_set_y)
    ...
    _ , forward_half0, backward_half0, shared_g_half0  = _compile(classifier_half0, 1, x, y, index, train_set_x, train_set_y)
    ...
    _ , forward_half1, backward_half1, shared_g_half1 = _compile(classifier_half1, 1, x, y, index, train_set_x, train_set_y)
    ...
    while (epoch < n_epochs):
        ...
        for minibatch_index in range(n_train_batches):
            ...
            cost_00 = forward_half0(minibatch_index*2)
            
            
            cost_01 = forward_half1(minibatch_index*2+1)
            
            
            ####----------------------------
            # exchange
            
            for param_0, param_1 in zip(shared_g_half0, shared_g_half1):
            ...
            # print cost and some updated parameter values for comparison
            print "h0h1:", (cost_00+cost_01)/2. , classifier_half0.params[0].eval()[0][1:5]
