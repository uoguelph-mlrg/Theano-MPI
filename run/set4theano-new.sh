module unload intel mkl openmpi hdf python cuda gcc
...
export LD_LIBRARY_PATH=/opt/sharcnet/gcc/4.9.2/lib64:/opt/sharcnet/cuda/7.5.18/lib64:/opt/sharcnet/testing/libgpuarray/lib:/opt/sharcnet/testing/nccl/lib:/opt/sharcnet/testing/cudnn/cudnn4:/opt/sharcnet/testing/caffe/caffe-libs/lib:$LD_LIBRARY_PATH
