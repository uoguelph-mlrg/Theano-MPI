...
case $size in
	...
	16)
		host1=cop1
		host2=cop2
		mpirun --mca btl_smcuda_use_cuda_ipc 1 --mca mpi_common_cuda_cumemcpy_async 1 -n 8 -host $host1 python -u ../lib/BSP_Worker.py : \
			   --mca btl_smcuda_use_cuda_ipc 1 --mca mpi_common_cuda_cumemcpy_async 1 -n 8 -host $host2 python -u ../lib/BSP_Worker.py
		;;
